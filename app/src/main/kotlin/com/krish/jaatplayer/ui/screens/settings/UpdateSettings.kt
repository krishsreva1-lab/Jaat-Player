...
import com.krish.jaatplayer.jaat.component.UpdateInfoDialog
...
import com.krish.jaatplayer.jaat.updater.saveUpdateNotificationsSetting
import android.widget.Toast
import androidx.compose.ui.res.pluralStringResource
import com.krish.jaatplayer.jaat.updater.getDownloadedApkCount
import com.krish.jaatplayer.jaat.updater.clearDownloadedApks
import com.krish.jaatplayer.jaat.updater.getBetaUpdatesSetting
import com.krish.jaatplayer.jaat.updater.saveBetaUpdatesSetting
import com.krish.jaatplayer.jaat.updater.autoClearOldApks
...
fun UpdateSettings(
    ...
    isHighlighted = (highlightKey == stringResource(R.string.system_update)),
                    ...
                    onClick = {
                        ...
                        if (isFoss) {
                            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/krishsreva1-lab/Jaat-Player"))
