...
fun LibraryScreen(navController: NavController) {
    ...
    if (showYoutubeImportDialog) {
        ...
        com.krish.jaatplayer.ui.component.TextFieldDialog(
    ...
    if (showCreatePlaylistDialog) {
        com.krish.jaatplayer.ui.component.CreatePlaylistDialog(
    ...
    if (showAiPlaylistDialog) {
        com.krish.jaatplayer.ui.component.CreateAiPlaylistDialog(
