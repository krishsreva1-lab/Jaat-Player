...
import com.krish.jaatplayer.constants.AutomixDebugOverlayKey
...
import com.krish.jaatplayer.constants.EnableGoogleCastKey
...
import com.krish.jaatplayer.constants.SeekExtraSeconds
...
import com.krish.jaatplayer.constants.EnableExportAsMp3Key
...
import com.krish.jaatplayer.utils.cipher.PlayerConfigStore
import com.krish.jaatplayer.utils.cipher.PlayerDatesStore
...
highlightKey: String? = null) {
    ...
    val (dataSaverEnabled, onDataSaverEnabledChange) = rememberPreference(
        key = com.krish.jaatplayer.constants.DataSaverEnabledKey,
        defaultValue = false
    )
    ...
    val (downloadQuality, onDownloadQualityChange) = rememberEnumPreference(
        com.krish.jaatplayer.constants.DownloadQualityKey,
        defaultValue = com.krish.jaatplayer.constants.DownloadQuality.YOUTUBE
    )
    ...
    if (showDownloadQualityDialog) {
        EnumDialog(
            ...
            onSelect = {
                if (it == com.krish.jaatplayer.constants.DownloadQuality.LOSSLESS) {
            ...
            values = listOf(com.krish.jaatplayer.constants.DownloadQuality.YOUTUBE, com.krish.jaatplayer.constants.DownloadQuality.LOSSLESS),
            valueText = {
                when (it) {
                    com.krish.jaatplayer.constants.DownloadQuality.YOUTUBE -> "YouTube Music (AAC/Default)"
                    com.krish.jaatplayer.constants.DownloadQuality.LOSSLESS -> "Lossless"
                }
            }
        )
    }
            ...
            DefaultDialog(
                ...
                buttons = {
                    ...
                    TextButton(onClick = {
                        ...
                        onDownloadQualityChange(com.krish.jaatplayer.constants.DownloadQuality.LOSSLESS)
                    }) {
                        Text(stringResource(R.string.enable))
                    }
                }
    ...
    isHighlighted = (highlightKey == stringResource(R.string.seek_seconds_addup)),
                ...
                add(Material3SettingsItem(
    isHighlighted = (highlightKey == stringResource(R.string.jaat_equalizer)),
                    icon = painterResource(R.drawable.jaatequlizer),
                    title = { Text(stringResource(R.string.jaat_equalizer)) },
                    description = { Text(stringResource(R.string.jaat_equalizer_desc)) },
    ...
    isHighlighted = (highlightKey == stringResource(R.string.export_desc)),
                ...
                Material3SettingsItem(
                    isHighlighted = (highlightKey == "Jaat Extractor"),
                    icon = painterResource(R.drawable.sync),
                    title = { Text("Jaat Extractor") },
                    description = { 
                        Text("Manage cipher updates and view history") 
                    },
                    onClick = { 
                        navController.navigate("settings/jaat_extractor")
                    }
                ),
            )
        )
