...
import com.krish.jaatplayer.constants.MaxImageCacheSizeKey
import com.krish.jaatplayer.constants.MaxSongCacheSizeKey
import com.krish.jaatplayer.extensions.tryOrNull
...
import com.krish.jaatplayer.ui.utils.formatFileSize
        ...
        ActionPromptDialog(
            ...
            onConfirm = {
                androidx.media3.exoplayer.offline.DownloadService.sendRemoveAllDownloads(
                    context,
                    com.krish.jaatplayer.playback.ExoDownloadService::class.java,
                    false
                )
