...
fun jaatPlayerLyricsLine(
    ...
    val wordData = remember(entry.text, entry.words, activeDuration) {
        val isHindiText = com.krish.jaatplayer.lyrics.LyricsUtils.isHindi(entry.text)
        ...
        FlowRow(
            ...
            wordData.forEachIndexed { index, (wordText, startRelative, endRelative) ->
                ...
                Text(
                    ...
                    style = TextStyle(
                        // A from-scratch style replaces the theme's, so the family is set here.
