...
import com.krish.jaatplayer.utils.enumPreference
...
constructor(
    ...
    private val downloadQuality by enumPreference(context, com.krish.jaatplayer.constants.DownloadQualityKey, com.krish.jaatplayer.constants.DownloadQuality.YOUTUBE)
            ...
            val playbackData = runBlocking(Dispatchers.IO) {
                YTPlayerUtils.playerResponseForPlayback(
                    ...
                    audioQuality = when (downloadQuality) {
                        com.krish.jaatplayer.constants.DownloadQuality.LOSSLESS -> AudioQuality.LOSSLESS
