...
import com.krish.jaatplayer.constants.MediaSessionConstants
...
constructor(
                            ...
                            parentId.startsWith("${MusicService.YOUTUBE_PLAYLIST}/") -> {
                                ...
                                try {
                                    val songs = YouTube.playlist(playlistId).getOrNull()?.songs
                                        ...
                                        ?.filterVideoSongs(context.dataStore.get(HideVideoSongsKey, false) || context.dataStore.get(com.krish.jaatplayer.constants.DataSaverEnabledKey, false))
                                        ?: emptyList()
    ...
    private fun com.krish.jaatplayer.db.entities.Playlist.toBrowsableMediaItem() = browsableMediaItem(
