...
import com.krish.jaatplayer.di.ApplicationScope
import com.krish.jaatplayer.extensions.toEnum
import com.krish.jaatplayer.extensions.toInetSocketAddress
import com.krish.jaatplayer.utils.CrashHandler
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        com.krish.jaatplayer.utils.cipher.CipherDeobfuscator.initialize(this)
        ...
        applicationScope.launch {
            ...
            launch(Dispatchers.Main) {
                runCatching { com.krish.jaatplayer.utils.cipher.CipherDeobfuscator.prewarm() }
            }
        }
    }
    ...
    private fun observeSettingsChanges() {
        ...
        com.krish.jaatplayer.utils.lastfm.LastFM.initialize(
