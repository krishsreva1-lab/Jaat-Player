...
import com.krish.jaatplayer.App
import com.krish.jaatplayer.utils.PlaybackLogManager
import com.krish.jaatplayer.utils.PlaybackLogLevel
    ...
    suspend fun rotateGuestSession() {
        ...
        withContext(Dispatchers.IO) {
            ...
            YouTube.refreshVisitorData().onSuccess { newData ->
                ...
                // Clear previously failed IDs to give them a fresh start with the new session
