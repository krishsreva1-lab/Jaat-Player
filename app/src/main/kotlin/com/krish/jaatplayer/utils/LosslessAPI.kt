...
object LosslessAPI {
    ...
    private suspend fun fetchMusicList(): List<LosslessTrack> = withContext(Dispatchers.IO) {
        ...
        try {
            val request = Request.Builder()
                .url("https://raw.githubusercontent.com/JaatPlayerApp/Lossless-Database/refs/heads/main/music.json")
                .get()
                .build()
    ...
    suspend fun search(queryTitle: String, queryArtist: String): LosslessTrack? {
        ...
        return track?.let {
            val resolvedUrl = it.url.replace(
                "https://lossless.jaatplayer.fun/Music/",
                "https://raw.githubusercontent.com/JaatPlayerApp/Lossless-Database/main/Music/"
            )
    ...
    suspend fun getDonationGoal(): DonationGoal = withContext(Dispatchers.IO) {
        try {
            val request = Request.Builder()
                .url("https://lossless.jaatplayer.fun/goal.json")
                .get()
                .build()
