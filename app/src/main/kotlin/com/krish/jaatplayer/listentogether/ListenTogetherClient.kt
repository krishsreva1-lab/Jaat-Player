...
package com.krish.jaatplayer.listentogether
...
import com.krish.jaatplayer.constants.ListenTogetherAutoApprovalKey
import com.krish.jaatplayer.constants.ListenTogetherIsHostKey
import com.krish.jaatplayer.constants.ListenTogetherRoomCodeKey
import com.krish.jaatplayer.constants.ListenTogetherServerUrlKey
import com.krish.jaatplayer.constants.ListenTogetherSessionTimestampKey
import com.krish.jaatplayer.constants.ListenTogetherSessionTokenKey
import com.krish.jaatplayer.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.krish.jaatplayer.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.krish.jaatplayer.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.krish.jaatplayer.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.krish.jaatplayer.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.krish.jaatplayer.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.krish.jaatplayer.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
