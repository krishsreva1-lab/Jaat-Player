...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    private fun openTargetInApp(context: Context, source: Intent) {
        val activityIntent = Intent(context, MainActivity::class.java).apply {
            action = "com.krish.jaatplayer.action.OPEN_WIDGET_TARGET"
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "com.krish.jaatplayer.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "com.krish.jaatplayer.widget.playlists.UPDATE_WIDGET"
