...
// Which visual style the Liquid Glass dock/menus use.
val LiquidGlassStyleKey = stringPreferencesKey("liquidGlassStyle") // "apple" or "material3"

// Independent per-menu toggles (Design Goals: per-menu control)
val LiquidGlassPlayerMenuEnabledKey = booleanPreferencesKey("liquidGlassPlayerMenuEnabled")
val LiquidGlassQueueMenuEnabledKey = booleanPreferencesKey("liquidGlassQueueMenuEnabled")
val LiquidGlassQualityMenuEnabledKey = booleanPreferencesKey("liquidGlassQualityMenuEnabled")
