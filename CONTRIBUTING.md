# Contributing to Jaat Player

Thank you for your interest in contributing to Jaat Player! This document provides comprehensive guidelines and information for contributors.
...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/Jaat-Player.git
   cd Jaat-Player
   ```
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/krishsreva1-lab/Jaat-Player.git
   ```
...
2. Add Android apps with package names:
   - `com.krish.jaatplayer` (release)
   - `com.krish.jaatplayer.debug` (debug)
...
When contributing to Jaat Player, it's crucial to handle sensitive information properly:
...
```
app/src/main/kotlin/com/krish/jaatplayer/
...
- **Packages**: lowercase (`com.krish.jaatplayer.ui`)
...
./gradlew test --tests "com.krish.jaatplayer.MusicPlayerTest"
...
1. Check the [GitHub Discussions](https://github.com/krishsreva1-lab/Jaat-Player/discussions)
...
Thank you for contributing to Jaat Player!
