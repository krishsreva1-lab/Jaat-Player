...
If you discover a security vulnerability in Jaat Player, please report it responsibly:

1. **Do NOT** create a public GitHub issue
2. Email us at: [security@jaatplayer.fun](mailto:security@jaatplayer.fun)
...
Jaat Player is committed to user privacy:
...
- Email: [security@jaatplayer.fun](mailto:security@jaatplayer.fun)
- GitHub: Create a private security advisory

Thank you for helping keep Jaat Player secure!
