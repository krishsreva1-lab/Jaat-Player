package com.krish.jaatplayer.jaatcanvas
...
@Serializable
data class jaatCanvasManifest(
    val items: List<jaatCanvasItem> = emptyList()
)

@Serializable
data class jaatCanvasItem(
    val song: String,
    val artist: String,
    val url: String
)

object jaatCanvasProvider {
    private const val BASE_URL = "https://canvas.jaatplayer.fun/canvas.json"
    ...
    private suspend fun fetchManifest(): jaatCanvasManifest? {
        ...
        return try {
            val manifest: jaatCanvasManifest = client.get(BASE_URL).body()
