<div align="center">
  <img src="assets/jaat_logo.png" alt="Jaat Player Logo" width="140"/>
  ...
  [![GitHub Release](https://img.shields.io/github/v/release/krishsreva1-lab/Jaat-Player?style=for-the-badge&color=6f42c1)](https://github.com/krishsreva1-lab/Jaat-Player/releases)
  [![GitHub Stars](https://img.shields.io/github/stars/krishsreva1-lab/Jaat-Player?style=for-the-badge&color=e3b341)](https://github.com/krishsreva1-lab/Jaat-Player/stargazers)
  [![License](https://img.shields.io/github/license/krishsreva1-lab/Jaat-Player?style=for-the-badge&color=28a745)](LICENSE)
...
Jaat Player delivers a seamless, premium listening experience by leveraging YouTube Music's vast library — without the ads. It adds powerful extras including offline downloads, real-time synchronized lyrics, and environment-aware music recognition.
...
- [Features](#features)
  ...
  - [Discovery & Jaat Find](#discovery--jaat-find)
  - [Lyrics](#lyrics)
...
<div align="center">
  <table style="margin: 0 auto; border-collapse: collapse;">
    ...
    <tr>
      ...
      <td align="center" style="padding: 10px; border: none;">
        <strong>Jaat Find (Recognition)</strong><br><br>
        <img src="Screenshots/sc_6.png" alt="Jaat Find" width="200" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);"/>
      </td>
    </tr>
  </table>
</div>
...
### Discovery & Jaat Find
- **Jaat Find** — Identify songs playing around you using advanced audio recognition.
- **Jaat Brain** — An intelligent, on-device engine that analyzes your listening momentum and auto-injects perfectly aligned tracks into your queue. Read more in the [Jaat Brain Documentation](JAAT_BRAIN_DOCS.md).
...
Download the latest pre-compiled APK from the [Releases Page](https://github.com/krishsreva1-lab/Jaat-Player/releases/latest).

### Building from Source

1. **Clone the Repository**
   ```bash
   git clone https://github.com/krishsreva1-lab/Jaat-Player.git
   cd Jaat-Player
   ```
...
4. **Build the Application**
   Jaat Player has two build variants: **FOSS** (without Google Play Services / Cast) and **GMS** (with Cast support).
...
Jaat Player stands on the shoulders of several excellent open-source projects. Sincere thanks to:
...
| [Music Recognizer](https://github.com/aleksey-saenko/MusicRecognizer) | Audio recognition (Jaat Find) |
| [Flow](https://github.com/a-edev/Flow) | AI queue generation engine (Jaat Brain) |
